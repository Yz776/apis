...
- **Added `/search/image`** (2026-09-19) — web image search returning thumbnail + full-res URL + title + source page. Backend: Bing Images, because Google now serves a JS-only shell to server-side clients. Params: `query` (required), `limit` (1–50), `safe` (on/moderate/off).
