// Auto-generated from r2-kana.vercel.app snippet "Uploader.js" (hpiXmuW)
// Source: https://r2-kana.vercel.app/#/snippet/hpiXmuW
...
async function uploadPostImages(imageUrl) {
  ...
  const imgRes = await fetch(imageUrl, {
    ...
    // Bun fetch supports `tls: { rejectUnauthorized: false }` via Node compat
  }).catch(async () => {
...
export default {
    route: {
        ...
        description: "Re-upload gambar dari URL ke postimages.org, kembalikan direct link + remove link.",
        parameters: [
            {
                name: "url",
                in: "query",
                required: true,
                description: "URL gambar yang akan diunggah ulang ke postimages.org",
